...
@Input() source:string='photo'; //posibilidades de galeria o photo

  imageData:string;

@Output() imageSelected= new EventEmitter<any>();
@Output() uploadFinished=new EventEmitter<any>();
  constructor(private camera:Camera,private storage:AngularFireStorage, private loadingCtrl:LoadingController) { }
